...
void xb2cvr_draw(XPLMWindowID xb2cvr_in_window_id, void * /*in_refcon*/) {
  ...
  g_page9_button_lbrt[2] =
      g_page9_button_lbrt[0] + 50; // *just* wide enough to fit the button text
  ...
  g_page10_button_lbrt[2] =
      g_page10_button_lbrt[0] + 50; // *just* wide enough to fit the button text
  ...
  g_page11_button_lbrt[2] =
      g_page11_button_lbrt[0] + 50; // *just* wide enough to fit the button text
  ...
  g_page12_button_lbrt[2] = g_page12_button_lbrt[0] + 50; // *just* wide enough
  to fit the button text
  g_page12_button_lbrt[1] = g_page12_button_lbrt[3] - (2.00f * char_height); //
  ...
  XPLMDrawString(col_black, g_page12_button_lbrt[0], g_page12_button_lbrt[1] +
  8, (char *)page12_btn_label, NULL, xplmFont_Proportional);
  ...
  g_page13_button_lbrt[2] = g_page13_button_lbrt[0] + 50; // *just* wide enough
  to fit the button text
  g_page13_button_lbrt[1] = g_page13_button_lbrt[3] - (2.00f * char_height); //
  a bit taller than the button text
  ...
  XPLMDrawString(col_black, g_page13_button_lbrt[0], g_page13_button_lbrt[1] +
  8, (char *)page13_btn_label, NULL, xplmFont_Proportional);
  ...
  g_page14_button_lbrt[2] = g_page14_button_lbrt[0] + 50; // *just* wide enough
  to fit the button text
  g_page14_button_lbrt[1] = g_page14_button_lbrt[3] - (2.00f * char_height); //
  a bit taller than the button text
  ...
  XPLMDrawString(col_black, g_page14_button_lbrt[0], g_page14_button_lbrt[1] +
  8, (char *)page14_btn_label, NULL, xplmFont_Proportional);
